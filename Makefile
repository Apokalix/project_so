...
all:
	...
	$(CC) $(CFLAGS) -c function_supp/shmMasterBook.c -o obj/shmMasterBook.o
	...
	$(CC) $(CFLAGS) main/master.c obj/shmFunctions.o obj/shmMasterBook.o obj/creationBook.o	-o exec/master
